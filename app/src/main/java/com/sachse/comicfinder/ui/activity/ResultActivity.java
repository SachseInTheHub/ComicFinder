...
public class ResultActivity extends BaseActivity {
    ...
    private void performCall(String query) {
        Timber.d("perfomCall");
        rx.Observable<CharacterDataWrapper> observable = mApiCall.getAllCharacters(100, 0);
...
//					mComicsRV.setAdapter(adapter);
//				}
//				final RealmResults<Character> character = realm.where(Character.class).contains("name", "Aginar").findAll();
//				Timber.d("Character"+ character.first().getName() + " name "+ character.first().getDescription());
//			}
//
//			@Override
